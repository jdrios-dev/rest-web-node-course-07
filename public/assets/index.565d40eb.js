...
function _c(e, t) {
	...
	if (t !== 0) {
		if (
			(t === 2 && ((l = zi(e)), l !== 0 && ((r = l), (t = to(e, l)))), t === 1)
		)
		...
		if (t === 6) ot(e, r);
			...
			switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
				...
				case 3:
					if (
						(ot(e, r), (r & 130023424) === r && ((t = Ko + 500 - Y()), 10 < t))
					) {
						if (Yr(e, 0) !== 0) break;
	...
	if (at !== null) {
		...
		try {
			if (((Ne.transition = null), (I = 16 > e ? 16 : e), at === null))
				...
				if (
					((M = l), kt(), He && typeof He.onPostCommitFiberRoot == "function")
				)
					try {
...
function Vr(e, t, n, r, l, i) {
	...
	if (((r = e), typeof e == "function")) Jo(e) && (o = 1);
		...
		e: switch (e) {
			...
			case pi:
				return (
					(e = Pe(12, n, t, l | 2)), (e.elementType = pi), (e.lanes = i), e
				);
			case hi:
			...
			case "bracket-separator":
				return (p, v, g) => {
					...
					const y =
						v === null
							? []
							: v.split(a.arrayFormatSeparator).map((z) => S(z, a));
					if (g[p] === void 0) {
						g[p] = y;
						return;
					}
	...
	(e.extract = P),
		...
		(e.stringify = (a, c) => {
			...
			(c = Object.assign(
				...
				f(c.arrayFormatSeparator);
			const p = (y) =>
					(c.skipNull && i(a[y])) || (c.skipEmptyString && a[y] === ""),
				v = u(c),
				g = {};
			...
			children: V(lo, {
				children: [
					E(Ge, {
						...
						element: E(xh, {
							children: E(lo, {
								children: E(Ge, { path: "/*", element: E(lh, {}) }),
							}),
						}),
					}),
